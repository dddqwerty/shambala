...
>>>>>>> 8d84d0d (this commit has the MainLayout file set up for the header and the footer. The header has also been made. Only thing left to compleat the header is the css.)
        </div>
      </div>
    </div>
  )
