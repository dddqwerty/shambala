...
const NaadamFirst = (props) => {
  ...
  return (
    <div className="relative w-screen h-screen">
      ...
      <div className="flex flex-row items-center invisible md:visible md:relative md:z-40 absolute -z-50">
      ...
      <div className=" w-full h-full flex flex-col z-40 top-0 items-center absolute md:hidden md:h-0 md:w-0">
