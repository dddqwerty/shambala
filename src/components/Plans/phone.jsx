...
export const Phone = (props) => {
  ...
  let styleBtm = ''
  if (top) {
    styleTop = 'bg-gradient-to-t from-[#C5C6CD]/30 to-backgroundColor-darkGray '
    if (active) {
      styleTop = 'bg-gradient-to-t from-primary-yellow to-backgroundColor-darkGray '
    }
  }
  if (btm) {
    styleBtm = 'bg-gradient-to-b from-[#C5C6CD]/30 to-backgroundColor-darkGray '
    if (active) {
      styleBtm = 'bg-gradient-to-b from-primary-yellow to-backgroundColor-darkGray'
    }
  }
  if (active) {
