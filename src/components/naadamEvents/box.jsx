...
export const Box = (props) => {
  ...
  return (
    <div className="invisible absolute -z-50 md:relative md:z-0 md:visible w-[400px] h-[250px] rounded-[8px] m-[12px] bg-[#373A3A4D] flex justify-center flex-col items-center">
