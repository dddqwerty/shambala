      ...
      <div className={`flex flex-col items-center max-w-shambWidth mx-auto z-20 relative ${PADDINGX}`}>
        ...
        <div className="flex w-[90%] md:w-[70%] flex-col text-center gap-14 mt-20">
          ...
          <Typography variant="body-web" className="text-primary-white opacity-60">
            Бидний "Art-Tech Empire" Лэнд Арт төсөл маань Дорноговь аймгийн, Төхөмийн хөндий, Ар цацын ус гэх байршлын 5
            га газарт нийт 30,000 ширхэг буюу 10,000 бортоготой мод тарих төсөл юм
          </Typography>
        </div>
        ...
        <div className="flex items-center flex-col text-center gap-14 w-4/5 relative">
          ...
          <Typography variant="body-web" className="text-primary-white opacity-60">
            NОНГОЛ УПСЫН ГАЗАР НУТГИЙН 76.8% НЬ Х6РСНV1Й ДОРОЙТОЛД ОРСОН БАV1НА. БV1Д Ц6ЛХV1Х БУЙ ГАЗАР ХУТАГТ НеХеН
            СЭРГЭЭПТ ХИ Й Н vОД ТАРЬХ Х6РСНИV1 ДОРОЙТОПТОV1 ТЭИЦДЭГ. VАНАЙ ХАХ/Т ОЛОН УРТ ХУГАЦААНЫ ТУРШ БV1ДЭНТЭV1
            ХАУТРАН АХИЛЛАН, БАЙ ГАП Ь ОРЧ И НДОО ХУВЬ НЭМ РЭЭ ОРУУПАХ ХУВЬ ХУН, АЛ БАН БАЙ ГУУЛЛАГА ТА БУХНИЙГУРЬХ
            БАV1НА.{' '}
          </Typography>
        </div>
        <div className="md:block mt-48 hidden w-[120%]">
          <div className="grid grid-cols-3 justify-center">
            <GoalCard
              index="01"
              desc="Цөлжилттэй газар нутагт тухайн газрын онцлогт тохирох модыг тарьж ургуулан нөхөн сэргээх"
            />
